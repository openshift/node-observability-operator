...
const (
	testSrcConfigMapName    = "test-kubelet-ca"
	testTargetConfigMapName = "kubelet-serving-ca"
)
...
func testConfig() Config {
	return Config{
		SourceNamespace: test.KubeletCASourceNamespace,
		TargetNamespace: test.OperatorNamespace,
...
func testRequest() ctrl.Request {
	return ctrl.Request{
		NamespacedName: types.NamespacedName{
			...
			Namespace: test.KubeletCASourceNamespace,
		},
	}
}
