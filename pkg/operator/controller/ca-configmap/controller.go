...
import (
	...
	controlleroperator "github.com/openshift/node-observability-operator/pkg/operator/controller"
...
func New(mgr manager.Manager, config Config) (controller.Controller, error) {
	...
	if err := c.Watch(
		...
		predicate.And(predicate.NewPredicateFuncs(ctrlutils.InNamespace(config.TargetNamespace)), predicate.NewPredicateFuncs(ctrlutils.HasName(controlleroperator.NamespacedKubeletCAConfigMapName("").Name))),
	); err != nil {
		return nil, err
	}
...
func (r *reconciler) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
	...
	if err := r.ensureKubeletCAConfigMap(ctx); err != nil {
